document.addEventListener('DOMContentLoaded', () => {
    ...
    function initCustomCursor() {
        ...
        const interactiveElements = document.querySelectorAll('a, button, .service-poster, .service-ribbon, .team-portrait-frame, .philosophy-pillar');
    ...
    function initCardRefinements() {
        const cards = document.querySelectorAll('.service-poster, .service-ribbon, .team-portrait-frame');
        cards.forEach(card => {
